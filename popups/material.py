...
class Ui_Material(object):
    def setupUi(self, Material):
        ...
        self.groupBox.setGeometry(QtCore.QRect(30, 30, 351, 181))
        ...
        self.pushButton_colorFromImage = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_colorFromImage.setGeometry(QtCore.QRect(240, 150, 101, 21))
        self.pushButton_colorFromImage.setObjectName("pushButton_colorFromImage")
    ...
    def retranslateUi(self, Material):
        ...
        self.pushButton_colorFromImage.setText(_translate("Material", "aus Bild lesen"))
